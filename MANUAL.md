...
and technical details, see [README.md](README.md).
...
If you were previously using the old `startup-config.sh` script directly via
autostart, disable that old entry once Startup Launcher's autostart is on,
or your programs will start twice — see the note at the bottom of
[README.md](README.md).
